...
```{r}
# Make Room_Occupancy_Count a factor
#occupancy_estimation$Room_Occupancy_Count <- factor(occupancy_estimation$Room_Occupancy_Count)

# Convert Date variable to a date
occupancy_estimation$Date <- as.Date(occupancy_estimation$Date, format="%Y/%m/%d")

# Make S6_PIR and S7_PIR factors
#occupancy_estimation$S6_PIR <- factor(occupancy_estimation$S6_PIR, levels=0:1, 
#                                      labels=c("No", "Yes"))
#occupancy_estimation$S7_PIR <- factor(occupancy_estimation$S7_PIR, levels=0:1, 
#                                      labels=c("No", "Yes"))
...
hist(occupancy_estimation$S5_CO2, 
     xlab="CO2 (PPM)", 
     main="Histogram of Sensor 5 CO2 Values",
     col="skyblue",
     border="black",
     breaks=8)
grid()
...
hist(occupancy_estimation$S5_CO2_Slope, 
     xlab="CO2 Slope", 
     main="Histogram of Sensor 5 CO2 Slope Values",
     col="skyblue",
     border="black",
     breaks=8)
grid()
